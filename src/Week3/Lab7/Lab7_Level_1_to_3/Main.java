...
public class Main {
    public static void main(String[] args) {
        ...
        Employee dep2Pos3EDup = new Employee("914", "Lin", "R", "Hon", LocalDate.of(1999, 5, 19), "43989533", 5000, dep2Pos3);

        System.out.println(dep2Pos3E.equals(dep2Pos2E));
        System.out.println(dep2Pos3E.equals(dep2Pos3EDup));
